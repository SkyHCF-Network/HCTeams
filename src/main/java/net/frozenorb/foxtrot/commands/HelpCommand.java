...
public class HelpCommand {
    ...
    public static void help(Player sender) {
        ...
        sender.sendMessage(new String[] {
                ...
                "§7§m-----------------------------------------------------",
                "§9Helpful Commands:",
                "§b/report <player> <reason> §7-§f Report cheaters!",
                "§b/request <message> §7-§f Request staff assistance.",
                "§b/tgc §7-§f Toggle chat visibility.",

                "",
                "§9Other Information:",
                "§bOfficial Teamspeak §7-§f ts." + serverWebsite,
                "§b" + serverName + " Rules §7-§f www." + serverWebsite + "/rules",
                "§bStore §7-§f store." + serverWebsite + "",
                "§7§m-----------------------------------------------------",
